...
MySQL
Hibernate: C'est l'un des ORM (Object Relational Mapping) les plus populaires pour Java 
...
public class SalariesRepositoryTest {
  ...
  ## Conclusion
Durant ce tutorial on a commencé l'intégration d'une base de données SQL (MySQL) en utilisant Spring Data et Hibernate pour réaliser   des opérations.
On continue avec les tutoriaux  de Spring Boot et MySQL par le mapping entre les différents types de relations entre les tables et one commence par la relation One to many dans le tutorial suivant. 
